...
const repairOptions = {
  screen: {
    icon: Smartphone,
    image: "/images/repair-screen-concept-v1.png",
  ...
  battery: {
    ...
    image: "/images/repair-battery-concept-v1.png",
  ...
  charging: {
    icon: PlugZap,
    image: "/images/repair-charging-concept-v1.png",
  ...
  liquid: {
    icon: Droplets,
    image: "/images/repair-liquid-concept-v1.png",
  ...
  board: {
    icon: CircleGauge,
    image: "/images/repair-board-concept-v1.png",
  ...
  data: {
    icon: Database,
    image: "/images/repair-data-concept-v1.png",
  ...
  return (
    <div className="repair-planner" aria-label={en ? "Choose a repair type" : "เลือกประเภทงานซ่อม"}>
      ...
      <div className="repair-result" role="tabpanel">
        <div className="repair-result-image">
          <Image src={repairOptions[active].image} alt={en ? `${item.tab} repair visual concept` : `ภาพแนวคิดงาน${item.tab}`} fill sizes="(max-width: 760px) 92vw, 300px" />
          <span>{en ? "AI VISUAL CONCEPT" : "ภาพแนวคิด AI"}</span>
        </div>
        <div>
